<footer class="pt-5 pb-4 footer-light">
    <div class="container-xl">
        <div class="row gy-4 align-items-start">
            ...
            <div class="col-lg-3 col-md-4 text-lg-start text-center">
            ...
            <div class="col-lg-5 col-md-8 text-lg-start text-center">
                <h6 class="text-uppercase text-secondary fw-semibold mb-3">Conversemos</h6>
                <div class="d-grid gap-2">
                    <a href="https://centroenlace.org" target="_blank" rel="noreferrer" class="d-flex align-items-center gap-3 mx-lg-0 mx-auto">
                        <span class="icon-circle icon-circle--outline mb-0"><i class="fa-solid fa-globe"></i></span>
                        <span>centroenlace.org</span>
                    </a>
                    <a href="mailto:contacto@centroenlace.org" class="d-flex align-items-center gap-3 mx-lg-0 mx-auto">
                        <span class="icon-circle icon-circle--outline mb-0"><i class="fa-solid fa-envelope"></i></span>
                        <span>contacto@centroenlace.org</span>
                    </a>
                    <a href="https://www.linkedin.com/company/centro-enlace/" target="_blank" rel="noreferrer" class="d-flex align-items-center gap-3 mx-lg-0 mx-auto">
